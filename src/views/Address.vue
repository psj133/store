  ...
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFileter" :key="item.tel" :class="{'check':checkedIndex==index}" @click="checkedIndex=index">
                  <dl>
                    <dt>{{item.userName}}</dt>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" @click="expand" :class="{'open':this.limit>3}">
                more
                <i class="i-up-down">
    ...
    <modal :mdshow="isMdShow" @close="closeModal">
      ...
      <div slot="btnGroup">
        ...
        <a class="btn btn--m" @click="this.isMdShow=false">取消</a>
      </div>
    </modal>
    <footer class="footer">
